...
public final class TeremClass {
    ...
    private int b_parameter; // Terem egyéb attributum, projektor vagy gepek
      ...
      public TeremClass(TeremType type, String TeremName, int MaxSzam, int Egyeb) { //konstruktor
        ...
        if ( t_name.length() == 0 ) {  } //random név generálás
    ...
    public String GetTeremName() { return t_name;}
    public TeremType GetTeremType(){ return t_type; }
    
  public static TeremType GetBeingTypeByStr(String TT){ //vissza adja a teremtipust sztring alapján
        if (TT.equalsIgnoreCase("0") ) { return TeremType.eloado; }
        else if (TT.equalsIgnoreCase("1") ) { return TeremType.szeminarium; }
        else if (TT.equalsIgnoreCase("2") ) { return TeremType.gepterem; }
        else { return null; }
    }
